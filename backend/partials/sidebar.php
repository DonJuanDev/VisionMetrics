<div class="sidebar">
    <div class="sidebar-header">
        <a href="/backend/dashboard.php" class="sidebar-logo">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                <path d="M13 2L3 14h8l-1 8 10-12h-8l1-8z" fill="#4F46E5"/>
            </svg>
            <?= APP_NAME ?>
        </a>
    </div>
    ...
    <div class="sidebar-menu">
        ...
        <a href="/backend/webhooks.php" class="sidebar-menu-item <?= basename($_SERVER['PHP_SELF']) === 'webhooks.php' ? 'active' : '' ?>">
            <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="/backend/client-access.php" class="sidebar-menu-item <?= basename($_SERVER['PHP_SELF']) === 'client-access.php' ? 'active' : '' ?>">
            <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="/backend/client-info.php" class="sidebar-menu-item <?= basename($_SERVER['PHP_SELF']) === 'client-info.php' ? 'active' : '' ?>">
            <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="/backend/support.php" class="sidebar-menu-item <?= basename($_SERVER['PHP_SELF']) === 'support.php' ? 'active' : '' ?>">
            <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="/backend/features.php" class="sidebar-menu-item <?= basename($_SERVER['PHP_SELF']) === 'features.php' ? 'active' : '' ?>">
            <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="/backend/settings.php" class="sidebar-menu-item <?= basename($_SERVER['PHP_SELF']) === 'settings.php' ? 'active' : '' ?>">
            <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            ...
            <a href="/backend/logout.php" style="color: #9CA3AF; font-size: 18px;" title="Sair">↗</a>
        </div>
    </div>
</div>
